...
3. [Mind The Line Quiz](./mpc_to_line) - Implement MPC and minimize cross track and orientation errors to a straight line trajectory.  See [this document](./install_Ipopt_CppAD.md) for setup tips for executing the plotting code in the ```MPC.cpp``` solution file.
...
you'll have to install Ipopt and CppAD.  Please refer to [this document](./install_Ipopt_CppAD.md) for installation instructions.
